---
title: "What is the trend of U.S. presidents' inaugrual speeches?"
...
Period 1: 1789-1865, George Washington-Abraham Lincoln (20 speeches)  
Period 2: 1866-1945, Ulysses S. Grant-Franklin D. Roosevelt (20 speeches)
Period 3: 1946-2017, Harry S. Truman-Donald J. Trump (20 speeches)
...
source("~/Documents/GitHub/GR5243 ADS/Spring2018-Project1-xxguo28/lib/plotstacked.R")
...
**I continue my research with sentiment changes of speakers.**
...
```
**I do not analyze these colors in detail, just make a demonstrate on the whole trend which these colorful plots show.**

I use darker colors to represent more intense emotions. 
...
ggplot(period.summary) +
  ...
  labs(y = "Attitude")
```
**From this plot we can see that presidents always express more positive attitude than negative. Meanwhile, there is a trend that they express more positive and less negative attitude than before.**

## Part III: Change in Topics of Presidents' Inaugrual Speeches

### Data Collection and Processing
For topic modeling, I still use one sentence as a unit. I prepare a corpus of sentence snippets as follows. 
```{r}
...
write.csv(ldaOut.topics,file=paste("~/Desktop/CU_Stats/2018 Spring/GR5243 ADS/Project 1/data/output/LDAGibbs",k,"DocsToTopics.csv"))

#top 20 terms in each topic
ldaOut.terms <- as.matrix(terms(ldaOut,20))
write.csv(ldaOut.terms,file=paste("~/Desktop/CU_Stats/2018 Spring/GR5243 ADS/Project 1/data/output/LDAGibbs",k,"TopicsToTerms.csv"))

#probabilities associated with each topic assignment
topicProbabilities <- as.data.frame(ldaOut@gamma)
write.csv(topicProbabilities,file=paste("~/Desktop/CU_Stats/2018 Spring/GR5243 ADS/Project 1/data/output/LDAGibbs",k,"TopicProbabilities.csv"))
```
